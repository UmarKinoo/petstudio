...
class Demo_Importer {
	...
	/**
	 * One-shot Home rebuild after restoring hero signature on text heading (v0.5.68+).
	 */
	public static function ensure_home_hero_signature_refresh(): void {
		$flag = 'pet_studio_ew_refreshed_hero_signature_20260812';
		if ( get_option( $flag ) ) {
			return;
		}
